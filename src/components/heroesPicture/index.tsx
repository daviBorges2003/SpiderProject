...
import ImageSpDr from "@public/spiders/sp-dr-14512.png";
import ImageSpiderHam from "@public/spiders/spider-ham-8311.png";
...
const heroesImage: Record<string, StaticImageData> = {
  ...
  "sp-dr-14512": ImageSpDr,
  "spider-ham-8311": ImageSpiderHam,
